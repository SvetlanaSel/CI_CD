...
В ходе работы были изучены основные команды Docker и методы взаимодействия с контейнерами: 
1. Изучены базовые команды Docker:
- docker run - запуск контейнеров с различными параметрами

- docker ps - просмотр запущенных контейнеров

- docker stop/rm - управление жизненным циклом контейнеров

2. Освоены методы конфигурации контейнеров:

- Проброс портов (-p 3000:3000) для доступа к веб-интерфейсу

- Использование имен контейнеров (--name metabase) для удобного управления

3. Получены практические навыки:

- Успешно запущен и настроен контейнер с Metabase - инструментом бизнес-аналитики

- Пройдена регистрация на странице сервиса

- Обеспечен доступ к веб-интерфейсу через порт 3000

Необходимый сервис удалось успешно настроить и запустить.
