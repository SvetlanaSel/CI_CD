...
<img width="837" height="568" alt="image" src="https://github.com/user-attachments/assets/e4a2b0d1-b33b-47f8-9cf6-051ae8f5c208" />


Вывод:
- Как можно увидеть на графике, наибольший запас товаров у поставщика - "ООО ОптТорг", самый большой запас товаров у всех поставщиков  - это книги. Также, можно просмотреть топ-10 товаров по остаткам различных категорий, например, среди бытовой химии (график 3)
...
## Вывод
В ходе выполнения работы был реализован полноценный готовый проект по созданию аналитических графиков в Streamlit. Получилось успешно выполнить все поставленные задачи и собрать статистику по складам.
